...
jQuery.extend(Boxy, {
	...
	WRAPPER:    "<table cellspacing='0' cellpadding='0' border='0' class='boxy-wrapper'><tr><td class='boxy-inner'></td></tr></table>",
    ...
    ask: function(question, answers, callback, options) {
        ...
        var buttons = jQuery('<div class="b_buttom"><form class="answers"></form></div>');
