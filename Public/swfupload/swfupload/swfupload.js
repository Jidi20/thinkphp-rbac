...
SWFUpload.prototype.getFlashHTML = function () {
	...
	return ['<object id="', this.movieName, '" type="application/x-shockwave-flash" zw="',this.settings.button_placeholder_id,'" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
...
SWFUpload.prototype.uploadSuccess = function (file, serverData) {
	file = this.unescapeFilePostParams(file);
        var ress = eval("("+serverData+")");
        if(ress.statusCode == 1){
            this.customSettings.successFile++;
            this.queueEvent("upload_success_handler", [file, serverData]);
        }else{
            this.subUploadedCount(1);
            this.queueEvent("upload_error_handler", [file, ress.statusCode, ress.info]);
        }
};
