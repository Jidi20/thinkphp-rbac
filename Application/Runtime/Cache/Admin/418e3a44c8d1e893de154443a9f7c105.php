			...
			<div class="result-title">
				<div class="result-list">
					<div class="result-list-left">
						<a href="/index.php/Admin/Basic/roleadd"><input type="button" class="butstyle mr10 bg1" value="新增角色"></a>					</div>
			...
			<div class="result-content">
				<table class="result-tab" width="100%">
					...
					<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
							...
							<td>
								<a href="/index.php/Admin/Basic/roledit/id/<?php echo ($vo["id"]); ?>" class="c1">修改</a> |
	...
	<script type="text/javascript">
		...
		function delete_one(id){
			Boxy.confirm("确定删除？", function() {
				$.post('/index.php/Admin/Basic/role_delete',{id:id},function(data){
					if(data.success == 1){
		...
		function search(){
			...
			var url = '/index.php/Admin/Basic/rolelist';
			if(keyword != ''){
				url += '/keyword/'+keyword;
			}
			location.href = url;
