			...
			<div class="result-title">
				<div class="result-list">
					<div class="result-list-left">
						<a href="/index.php/Admin/Basic/admin_add"><input type="button" class="butstyle mr10 bg1" value="新增人员"></a>					</div>
			...
			<div class="result-content">
				<table class="result-tab" width="100%">
					...
					<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
							...
							<td><?php if($vo["is_lock"] == 1): ?><span class="c1">没锁定</span><?php else: ?><span class="c2">锁定</span><?php endif; ?></td>
							<td>
								<a href="/index.php/Admin/Basic/admin_edit/id/<?php echo ($vo["id"]); ?>" class="c1">修改</a> |
	...
	<script type="text/javascript">
		...
		function delete_one(id){
			Boxy.confirm("确定删除？", function() {
				$.post('/index.php/Admin/Basic/admin_delete',{id:id},function(data){
					if(data.success == 1){
						Boxy.alert(data.message, null);
	 					window.location.href="/index.php/Admin/Basic/admin_list";
		 			}else{
		 				Boxy.alert(data.message, null);
						return false;
		 			}
		...
		function search(){
			...
			var url = '/index.php/Admin/Basic/admin_list';
			if(keyword != ''){
				url += '/keyword/'+keyword;
			}
			location.href = url;
